...
export const Resume = () => {
  ...
  return (
    <div className="resume">
      <div className="resume-heading" onClick={() => setShowEdu(!showEdu)}>
        <h2>Education </h2>
        <h3>{showEdu ? <BsFillCaretDownFill /> : <BsFillCaretLeftFill />}</h3>
      </div>
      {showEdu && (
        <div>
          <h3>App Academy</h3>
          ...
          <ul>
            ...
            <li>
              4 full-stack projects built with JavaScript, React, and Python
            </li>
      ...
      <div className="resume-heading" onClick={() => setShowExp(!showExp)}>
        <h2>Experience </h2>
        <h3>{showExp ? <BsFillCaretDownFill /> : <BsFillCaretLeftFill />}</h3>
      </div>
      {showExp && (
        <div>
          <h3>Retail Sales</h3>
          ...
          <ul>
            ...
            <li>
              ...
              listings ensuring a harmonious online/in-person shopping
              experience.
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              curating an original and eclectic bar program that highlighted
              local and small-scale producers.
            </li>
            <li>
              Trained front-of-house staff on standards of service for all
              aspects of the restaurant, including guest interaction.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              customers, to tracking physical inventory, to fulfilling orders
              and ensuring proper delivery.
            </li>
            <li>
              Collaborated with distributors in over 20 different domestic and
              international markets to ensure wholesale wine was delivered
              quickly and accurately.
            </li>
            <li>
              Maintained tax compliance for the winery on a monthly, quarterly,
              and annual basis with the corresponding federal and state level
              authorities.
            </li>
          </ul>
          ...
          <ul>
            <li>
              Spearheaded the updating of the school’s website and promotional
              materials
            </li>
            <li>
              Worked closely with the principal to develop marketing strategies
              to increase enrollment
            </li>
            <li>
              Relied on Mandarin Chinese to communicate with staff, students,
      ...
      <div className="resume-heading" onClick={() => setShowAwa(!showAwa)}>
        <h2>Awards </h2>
        <h3>{showAwa ? <BsFillCaretDownFill /> : <BsFillCaretLeftFill />}</h3>
      </div>
      {showAwa && (
        <div>
          <h3>Chinese Government Scholarchip, full-ride</h3>
